...
- **Local AI Book Reader** → PDF/EPUB + zero hallucinations (still in stealth mode)
...
### Let's connect
- X → [@nkcbuilds](https://x.com/nkcbuilds)

---
**Currently grinding:** Making the screen recorder production-ready.
